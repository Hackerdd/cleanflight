...
static const paramValue_t valueTable[] = {
    ...
    { GROUP_MMIX,  MMIX_MOTOR_0,               VAR_MMIX,       &masterConfig.customMotorMixer[0], -1, 1},
    { GROUP_MMIX,  MMIX_MOTOR_1,               VAR_MMIX,       &masterConfig.customMotorMixer[1], -1, 1},
    { GROUP_MMIX,  MMIX_MOTOR_2,               VAR_MMIX,       &masterConfig.customMotorMixer[2], -1, 1},
    { GROUP_MMIX,  MMIX_MOTOR_3,               VAR_MMIX,       &masterConfig.customMotorMixer[3], -1, 1},
    { GROUP_MMIX,  MMIX_MOTOR_4,               VAR_MMIX,       &masterConfig.customMotorMixer[4], -1, 1},
    { GROUP_MMIX,  MMIX_MOTOR_5,               VAR_MMIX,       &masterConfig.customMotorMixer[5], -1, 1},
    { GROUP_MMIX,  MMIX_MOTOR_6,               VAR_MMIX,       &masterConfig.customMotorMixer[6], -1, 1},
    { GROUP_MMIX,  MMIX_MOTOR_7,               VAR_MMIX,       &masterConfig.customMotorMixer[7], -1, 1},
    { GROUP_MMIX,  MMIX_MOTOR_8,               VAR_MMIX,       &masterConfig.customMotorMixer[8], -1, 1},
    { GROUP_MMIX,  MMIX_MOTOR_9,               VAR_MMIX,       &masterConfig.customMotorMixer[9], -1, 1},
    { GROUP_MMIX,  MMIX_MOTOR_10,              VAR_MMIX,       &masterConfig.customMotorMixer[10], -1, 1},
    { GROUP_MMIX,  MMIX_MOTOR_11,              VAR_MMIX,       &masterConfig.customMotorMixer[11], -1, 1},
};
