...
const timerHardware_t timerHardware[USABLE_TIMER_CHANNEL_COUNT] = {
    ...
    { TIM5,  IO_TAG(PA1),  TIM_Channel_2, TIM_USE_MOTOR, 1, GPIO_AF_TIM5, DMA1_Stream4, DMA_Channel_6, DMA1_ST4_HANDLER }, // S5_OUT
    //{ TIM5,  IO_TAG(PA0),  TIM_Channel_1, TIM_USE_MOTOR | TIM_USE_PPM, 1, GPIO_AF_TIM5, DMA1_Stream2, DMA_Channel_6, DMA1_ST2_HANDLER }, // S6_OUT
	{ TIM5,  IO_TAG(PA0),  TIM_Channel_1, TIM_USE_PPM, 0, GPIO_AF_TIM5, NULL, 0, 0 }, // S6 used as PPM
	{ TIM4,  IO_TAG(PB7),  TIM_Channel_2, TIM_USE_LED  , 1, GPIO_AF_TIM4, DMA1_Stream3, DMA_Channel_2, DMA1_ST3_HANDLER }, // LED_OUT
};
